...
测试网络设计：
1、本地高性能电脑（代号：4090）作为算力节点，网络环境为中国大陆ISP
2、本地低性能笔记本电脑（代号：ubuntu-laotop）作为验证节点，网络环境为中国大陆ISP
3、日本低性能VPS服务器（代号：ubuntu-jp）作为验证节点，网络环境为日本ISP
4、洛杉矶低性能VPS服务器（代号：ubuntu-la）作为验证节点，网络环境为美国ISP
5、阿姆斯特丹低性能VPS服务器（代号：ubuntu-am）作为验证节点，网络环境为欧洲ISP
6、利用github
  1、作为CI/CD 流程
   - 代码质量检查
   - 单元测试
